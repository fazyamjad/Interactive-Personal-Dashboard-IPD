// Personal Dashboard JavaScript with Dark Mode & Timer
...
// ============================================
// LIVE TIMER - TRACKS TIME SPENT ON PAGE
// ============================================
...
// ============================================
// TAB VISIBILITY - COUNTDOWN WHEN USER LEAVES
// ============================================
document.addEventListener('visibilitychange', () => {
    if (document.hidden) {
        let secondsLeft = 5;
        const titleBackup = document.title;
        document.title = `⏳ Returning in ${secondsLeft}s`;
        ...
        setTimeout(() => { 
            document.title = "Personal Dashboard - Faizan"; 
        }, 3000);
    }
});
...
window.addEventListener('beforeunload', () => {
    ...
    const elapsed = Math.floor((Date.now() - startTime) / 1000);
    console.log(`Total time spent: ${elapsed} seconds`);
});
...
const projects = [
    ...
    },
    {
        ...
        description: 'An intelligent task management system that uses machine learning to predict task completion times and prioritize tasks based on user behavior patterns.',
        technologies: ['Python', 'TensorFlow', 'React', 'FastAPI', 'PostgreSQL'],
        problem: 'Traditional task managers lack intelligent prioritization and realistic time estimates, leading to poor time management.',
        proposition: 'ML-powered system that learns from user patterns to provide accurate time estimates and smart task prioritization.',
        competitors: 'Todoist, Asana, Microsoft To Do',
        link: 'https://github.com/yourusername/ai-task-manager',
        demo: 'https://ai-task-demo.netlify.app',
        category: 'ai'
    }
];
